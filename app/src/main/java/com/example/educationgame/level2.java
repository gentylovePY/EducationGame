...
private Button onClickBack;
    ...
    public int count = 0;
    public TextView onClickXEnd;
    public ImageView previwimg;
    public int i1 =0;
    public TextView     textView_description_end;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView_description.setText(R.string.leveltwo);
        previwimg = dialog.findViewById(R.id.previwimg);
        previwimg.setImageResource(R.drawable.previewimglevel2);
        ...
        textView_description_end = dialogend.findViewById(R.id.textView_description_end);

        textView_description_end.setText(R.string.leveltwo_end);
        ...
        //Анимация
        final Animation a = AnimationUtils.loadAnimation(level2.this,R.anim.beta);

        numleft = randrom.nextInt(10);//генерация
        img_left.setImageResource(array.images2[numleft]);
        text_left.setText(array.texts2[numleft]);//достаем из масива текст
        ...
        text_right.setText(array.texts2[numright]);//достаем из масива текст
    ...
    public void onClickContinuelevel1(View view){
        ...
        try { Intent intent = new Intent(level2.this,level1.class);
            startActivity(intent);finish();
        }catch (Exception e){
    ...
    public void onClickXEnd(View view){
        ...
        try {Intent intent = new Intent(level2.this,MainActivity.class);
            startActivity(intent);finish();
        }catch (Exception e){
